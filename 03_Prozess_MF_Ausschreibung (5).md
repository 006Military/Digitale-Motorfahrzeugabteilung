...
### Schritt 4: Dokument weiter befüllen (Modalitäten/Anforderungen)

- **Arbeitsweise:** parallel zum Warten auf die Versicherer-Unterlagen – Silvan befüllt bereits, was unabhängig davon feststeht. **Hinweis:** ist persönliche Arbeitsweise, nicht standardisiert im Team ("das macht jeder anders").
- **Was zuerst befüllt wird (unabhängig von Versicherer-Antwort):** Kundendaten/Adresse, Tätigkeitsbeschrieb, mitversicherte Firmen, aktueller Versicherer, Police-Ablauf, Beginn neuer Vertrag, gewünschte Zahlungsart des Kunden, Wunsch zur Schadenkorrespondenz
- **Sobald verfügbar:** Rendement wird ergänzt, sobald geliefert/downloadbar
- **Einzelschadenliste wird bewusst immer mitbestellt** (auch wenn nicht zwingend nötig), weil einzelne Versicherer sie ohnehin verlangen – so muss nicht in einer zweiten Runde nachgefordert werden
- **Wichtige Randbedingung:** Die interne Abstimmung zwischen Consultant und Mandatsleiter zu gewünschten Leistungen/Optionen ist kein eigener vorgelagerter Schritt, sondern findet typischerweise erst hier statt, ausgelöst durchs Ausfüllen des Dokuments

### Schritt 5: Übergabe an den Mandatsleiter zur Kontrolle

- **Ablauf:** Silvan verfasst eine Mail an den Mandatsleiter mit Link zum Word-Dokument in SharePoint, informiert dass die Ausschreibung fertig vorbereitet ist, und nennt eine Rückmeldefrist
- **Prüfumfang:** der Mandatsleiter kontrolliert die **gesamte Ausschreibung**, nicht nur Teile – da er immer im Lead ist und die Kundenverantwortung trägt. Laut Silvan ein **unabdingbarer Schritt** (bewusste menschliche Freigabe, keine Automatisierungskandidat für den Entscheid selbst)
- **Dauer:** grundsätzlich 3–4 Arbeitstage Frist, abhängig von der aktuellen Auslastung des Mandatsleiters
- **Bei Änderungswunsch:** hängt vom Umfang ab – bei grösseren inhaltlichen Fehlern geht das Dokument nach der Korrektur nochmals zurück zum Mandatsleiter (zweite Kontrollrunde); bei Kleinigkeiten (z.B. falsch geschriebene Adresse/Name) wird direkt an die Versicherer versendet, ohne erneute Kontrolle

### Schritt 6: Versand an ausgewählte Versicherer

- **Bestehender Versicherer – differenziert nach Auslöser:**
  - bei **Weg 1 (Sanierung)**: der Bestandesversicherer wird nicht separat angeschrieben, da mit der Sanierungsmeldung bereits eine Offerte von ihm vorliegt
  - bei **Weg 2 (Kundenwunsch auszuschreiben)**: der Bestandesversicherer wird ebenfalls angefragt, ob er eine (neue) Offerte einreichen möchte
- **Versandart an die übrigen:** eine Mail an alle ausgewählten Versicherer gemeinsam per BCC, mit allgemeiner Anrede ("Guten Tag")
- **Auswahl der angeschriebenen Versicherer** (wird mit dem Mandatsleiter besprochen):
  - typischerweise werden zuerst 3–4 Versicherer angeschrieben ("1. AP"-Runde): meist AXA, Helvetia, Allianz, Generali, Zürich
  - kommen von diesen keine Offerten, wird der Kreis auf die restlichen der 9 (Simpego, Smile, Mobiliar, Vaudoise) erweitert
  - hat der Kunde bereits andere bestehende Verträge bei einer bestimmten Gesellschaft, wird diese meist bevorzugt mitberücksichtigt
  - der Kunde kann einzelne Versicherer explizit ausschliessen (z.B. wegen schlechter Erfahrungen)
- **Deadline für Offertabgabe:** maximal 10–14 Arbeitstage; je früher im Prozess gestartet wird, desto mehr Zeit erhalten die Versicherer

### Schritt 7: Rückmeldungen der Versicherer sammeln

- **Tracking:** in der Ausschreibungs-Entität in WinVS gibt es ein Bemerkungsfeld, in das Silvan pro Gesellschaft Status und Datum einträgt (z.B. "Allianz – Offerte 11.09.2026" oder "AXA – Absage 11.09.2026")
- **Archivierung:** die Mail der Gesellschaft (Offerte oder Absage) wird zusätzlich vollständigkeitshalber in SharePoint abgelegt – so ist der Stand jederzeit nachvollziehbar, auch falls das Bemerkungsfeld mal nicht gepflegt wurde
- **Umgang mit verstrichener Deadline:** **sehr individuell je Consultant**, keine einheitliche Teamregel:
  - Silvans persönliche Haltung: Deadline ist Deadline, kein Nachfassen ("wer's nicht schafft, hat Pech")
  - andere Kolleg:innen schreiben Versicherer teils noch einen Tag vor Fristablauf nochmals an
  - Ausnahme auch bei Silvan: Wenn bisher nur Absagen vorliegen und ein Versicherer die Deadline knapp überschritten hat, wird nicht abgesagt, sondern noch auf dessen Offerte gewartet, in der Hoffnung auf ein besseres Angebot
